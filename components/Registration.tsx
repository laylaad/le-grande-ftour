    ...
    <section id="inscription" className="py-24 md:py-48 bg-luxuryGray relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        <FadeIn className="text-center mb-20">
          <h2 className="text-luxuryGold tracking-[0.4em] uppercase text-[10px] font-bold mb-6">Rejoindre l'Élite</h2>
          ...
          <p className="text-luxuryTextGray font-light text-lg">
            Veuillez renseigner vos informations pour soumettre votre demande de participation au Grand Ftour 2026.
          </p>
        </FadeIn>
        ...
        {isSubmitted ? (
          <FadeIn className="bg-luxuryBlack p-16 border border-luxuryGold/30 text-center shadow-2xl">
            <div className="w-20 h-20 bg-luxuryGold/10 border border-luxuryGold rounded-full flex items-center justify-center mx-auto mb-8">
              <svg className="w-10 h-10 text-luxuryGold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"/></svg>
            </div>
            ...
            <p className="text-luxuryTextGray text-lg mb-10 font-light">
              Notre service protocole reviendra vers vous avec les modalités d'accès.
            </p>
            <button 
          ...
          <FadeIn className="bg-luxuryBlack p-10 md:p-20 border border-white/5 shadow-2xl">
            <form onSubmit={handleSubmit} className="space-y-12">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="group relative">
                  <label className="block text-[10px] tracking-ultra-widest text-luxuryGold uppercase mb-2 font-bold opacity-60">Email Professionnel</label>
                  <input
                    type="email"
                    required
                    className="w-full bg-transparent border-b border-white/10 py-4 text-white focus:outline-none focus:border-luxuryGold transition-all duration-500 font-light text-lg"
                    placeholder="k.ben@entreprise.ma"
              ...
              <div className="pt-8">
                <button
                  type="submit"
                  className="w-full py-6 bg-luxuryGold text-luxuryBlack font-bold text-xs tracking-ultra-widest uppercase hover:bg-white transition-all duration-500 shadow-2xl shadow-luxuryGold/20"
                >
